...
$DOCKER_MACHINE_NAME='jekyl-docker'
...
$ip = $(docker-machine ip $DOCKER_MACHINE_NAME) + ":4000:4000"

docker run --rm  `
--label=jekyll `
--volume=${host_vol}:/srv/jekyll `
-it `
--publish 4000:4000 `
$DOCKER_IMAGE_NAME `
jekyll  serve --watch --drafts --force_polling -H 0.0.0.0 --baseurl ""
